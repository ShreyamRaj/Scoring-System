    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pointA_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((scoreTeamA == 21 ) && (scoreTeamA > scoreTeamB + 1)){
                    ...
                    setTeamA++;
                    if(setTeamA == 3){
                        Toast.makeText(Football.this, "Team A won the Tournament", Toast.LENGTH_LONG).show();
                        setTeamA = 0;
                        setTeamB = 0;
                        setTeamA_tv.setText(Integer.toString(setTeamA));
                        setTeamB_tv.setText(Integer.toString(setTeamB));
                    }
                    Toast.makeText(Football.this, "Team A won the set", Toast.LENGTH_LONG).show();
                }
        ...
        pointB_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((scoreTeamB == 21 ) && (scoreTeamB > scoreTeamA + 1)){
                    ...
                    setTeamB++;
                    if(setTeamB == 3){
                        Toast.makeText(Football.this, "Team B won the Tournament", Toast.LENGTH_LONG).show();
                        setTeamA = 0;
                        setTeamB = 0;
                        setTeamB_tv.setText(Integer.toString(setTeamA));
                        setTeamB_tv.setText(Integer.toString(setTeamB));
                    }
                    Toast.makeText(Football.this, "Team B won the set", Toast.LENGTH_LONG).show();
        ...
        reset_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                scoreTeamA_tv.setText(Integer.toString(scoreTeamA));
                scoreTeamB_tv.setText(Integer.toString(scoreTeamB));
                Toast.makeText(Football.this, "Score has been set to 0", Toast.LENGTH_LONG).show();
